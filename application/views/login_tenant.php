            ...
            <div class="col-lg-6">
                <div class="login_box_img">
                    ...
                    <div class="hover">
                        ...
                        <a class="primary-btn" href="<?php echo base_url('registrasi/registtenant'); ?>">Become a Partner</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="login_form_inner">
                    ...
                    <form class="row login_form" action="<?php echo base_url('auth/login_tenant')?>" method="post" id="contactForm" novalidate="novalidate">
