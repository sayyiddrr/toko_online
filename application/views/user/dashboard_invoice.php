                        ...
                        <div class="container-fluid">
                            <div class="dashboard-heading">
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <?php foreach ($invoice as $t_inv): ?>
                                        <tr>
                                            <td><?php echo $t_inv->ID_Generate_Number?></td>
                                            <td><?php echo $t_inv->Nama?></td>
                                            <td><?php echo $t_inv->Alamat?></td>
                                            <td><?php echo $t_inv->Tgl_Pesanan?></td>
                                            <td><?php echo $t_inv->Batas_Bayar?></td>
                                            <td><?php echo anchor('customer/customer_controller/detail/'.$t_inv->ID_Invoice, '<div class="btn btn-sm btn-warning">Detail</div>') ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </table>  
                            </div>
